...
public static class ContactSolver
{
	public static void Resolve(ref List<Contact> contacts)
	{
		foreach (Contact contact in contacts)
		{
			...
			contact.bodyA.ApplyForce( impulse * contact.bodyA.inverseMass, PhysicsBody.eForceMode.VELOCITY);
			contact.bodyB.ApplyForce(-impulse * contact.bodyB.inverseMass, PhysicsBody.eForceMode.VELOCITY);
		}
	}
}
